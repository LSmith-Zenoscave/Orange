...
void register_irq_handler(unsigned char n, irq_handler_t handler) { irq_handlers[n] = handler; }
void unregister_irq_handler(unsigned char n) { irq_handlers[n] = default_irq_handler; }

void register_isr_handler(unsigned char n, isr_handler_t handler) { isr_handlers[n] = handler; }
void unregister_isr_handler(unsigned char n) { isr_handlers[n] = default_fault_handler; }
