 ...
 * ---------------------------------------------------------------------------
 */
heap_t *create_heap(unsigned int *start, unsigned int *heap_end, unsigned char supervisor,
                    unsigned char ro) {
  assert(((unsigned int)start & 0xFFF) == 0);
  assert(((unsigned int)heap_end & 0xFFF)  == 0);

  heap_t *heap = (heap_t *)kmalloc(sizeof(heap_t));
  heap->header = (heap_header_t *)start;
  heap->header->size = (unsigned int)((unsigned int *)heap_end - (unsigned int *)start);
 ...
 * ---------------------------------------------------------------------------
 */
void *khalloc(size_t size, heap_t *heap) {
